...
since been identified in conformal field theories~\cite{Murciano2024}, random unitary
circuits, open quantum systems~\cite{Carollo2021},
and integrable chains~\cite{Rylands2024}.
...
\begin{itemize}
  \item \textbf{Z2 QME is generic in integrable systems.}
    The Z2 quantum Mpemba effect occurs for \emph{all} post-quench field values tested
    (23 values spanning the FM and PM phases, $\gf \in [0.1, 3.0]$), confirming
    that integrability supports, rather than suppresses, Z2 QME.
    This sharply contrasts with chaotic circuits where Z2 QME is absent.
